...
deleteModal.addEventListener('show.bs.modal', event => {
    ...
    modalUrl.href = "${pageContext.request.contextPath}/goods/delete?id=" + goods_id
})
...
sellerConfirmModal.addEventListener('show.bs.modal', async event => {
    ...
    if (result === 'true') {
        ...
        const modalUrl = deleteModal.querySelector('a')
        modalUrl.href = "${pageContext.request.contextPath}/order/sellerconfirm?id=" + goodsId
    }
})
...
buyerConfirmModal.addEventListener('show.bs.modal', async event => {
    ...
    if (cancelResult === 'true') {
        ...
        if (confirmResult === 'false') {
            ...
            modalUrl.href = "${pageContext.request.contextPath}/order/buyerconfirm?id=" + goodsId;
        }
    }
});
...
cancelModal.addEventListener('show.bs.modal', event => {
    ...
    modalUrl.href = "${pageContext.request.contextPath}/order/cancel?id=" + goodsId;
});
...
sellerDeleteModal.addEventListener('show.bs.modal', event => {
    ...
    modalUrl.href = "${pageContext.request.contextPath}/order/sellerdelete?id=" + goodsId;
});
...
buyerDeleteModal.addEventListener('show.bs.modal', event => {
    ...
    modalUrl.href = "${pageContext.request.contextPath}/order/buyerdelete?id=" + goodsId;
});
