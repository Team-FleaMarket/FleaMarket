...
<%--head--%>
<body>
<section class="background-header-body min-vh-100">
    <%--header--%>
                    ...
                    <div class="col-md-8 right">
                        ...
                        <div class="input-box">
                            ...
                            <div class="contact-form">
                                ...
                                <div class="contact-method">
                                    ...
                                    <p class="options-p">
                                        <i class="fas fa-caret-down triangle-down"></i>
                                        <i class="fas fa-caret-right triangle-up"></i>
                                        <a class="options" data-bs-toggle="collapse" href=".multi-collapse" role="button"
                                           aria-expanded="false" aria-controls="multiCollapseExample1 multiCollapseExample2 multiCollapseExample3">Toggle first element</a>
                                    </p>
                                    ...
                                    <div class="collapse multi-collapse" id="multiCollapseExample1">
                                        ...
                                        <div class="input-group mb-2">
                                            ...
                                            <div class="form-floating">
                                                <input type="text" class="form-control optional-form-control" id="wechat" name="wechat" placeholder="">
                                    ...
                                    <div class="collapse multi-collapse" id="multiCollapseExample2">
                                        ...
                                        <div class="input-group mb-2">
                                            ...
                                            <div class="form-floating">
                                                <input type="text" class="form-control optional-form-control" id="qq" name="qq" placeholder="">
                                    ...
                                    <div class="collapse multi-collapse" id="multiCollapseExample3">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <div class="form-floating">
                                                <input type="text" class="form-control optional-form-control" id="email" name="email" placeholder="">
                        ...
                        <script type="module">
                            ...
                            document.querySelector("#liveToastBtn").onclick = async () => {
                                ...
                                // 这三个可以不填，但是如果点开了下拉然后不填，就是空字符串，这里应该置为 null
                                if (wechat === "") {
                                    wechat = null
                                }
                                if (qq === "") {
                            ...
                            // 获取所有的输入框
                            const optionalInputFields = document.querySelectorAll('.optional-form-control');
                            // 遍历每个输入框
                            optionalInputFields.forEach((input) => {
                                // 监听输入事件
                                input.addEventListener('input', () => {
                                    // 如果输入框有内容
                                    if (input.value.trim() !== '') {
                                        // 去除对应的collapse类
                                        input.closest('.collapse').classList.remove('multi-collapse');
                                    } else {
                                        // 恢复对应的collapse类
                                        input.closest('.collapse').classList.add('multi-collapse');
                                    }
                                });
                            });
                            ...
                            const isInputLegal = (studentNo, name, department, phone, wechat, qq, email, password, repassword) => {
                                ...
                                if(studentNo !== null && studentNo !== "" && studentNo.length > 30){
                                    $("input[name=studentNo]").focus();
                                    layer.tips('学号不应超过 30 个字符！', '#studentNo', {
                                        tips: [2, '#FF3030'],
                                        time: 2000
                                    });
                                    return false;
                                ...
                                if(!/^\d+$/.test(studentNo)){
                                    $("input[name=studentNo]").focus();
                                    layer.tips('学号中应只含有数字！', '#studentNo', {
                                        tips: [2, '#FF3030'],
                                        time: 2000
                                    });
                                    return false;
                                ...
                                if(department !== null && department !== "" && department.length > 30){
                                    $("input[name=department]").focus();
                                    layer.tips('学院名称不应超过 30 个字符！', '#department', {
                                        tips: [2, '#FF3030'],
                                        time: 2000
                                    });
                                    return false;
                                ...
                                if(phone !== null && phone !== "" && phone.length > 30){
                                    $("input[name=phone]").focus();
                                    layer.tips('手机号不应超过 30 个字符！', '#phone', {
                                        tips: [2, '#FF3030'],
                                        time: 2000
                                    });
                                    return false;
                                ...
                                // 微信号
                                if(wechat !== null && wechat !== "" && wechat.length > 30){
                                    $("input[name=wechat]").focus();
                                    layer.tips('微信号不应超过 30 个字符！', '#wechat', {
                                        tips: [2, '#FF3030'],
                                        time: 2000
                                    });
                                    return false;
                                ...
                                // QQ
                                if(qq !== null && qq !== "" && qq.length > 30){
                                    $("input[name=qq]").focus();
                                    layer.tips('QQ 号不应超过 30 个字符！', '#qq', {
                                        tips: [2, '#FF3030'],
                                        time: 2000
                                    });
                                    return false;
                                ...
                                if(email !== null && email !== "" && email.length > 50){
                                    ...
                                    layer.tips('邮箱地址不应超过 50 个字符！', '#email', {
                                        tips: [2, '#FF3030'],
                                        time: 2000
                                    });
                                    return false;
                                ...
                                if(password !== null && password !== "" && password.length > 30){
                                    $("input[name=password]").focus();
                                    layer.tips('密码不应超过 30 个字符！', '#password', {
                                        tips: [2, '#FF3030'],
                                        time: 2000
                                    });
                                    return false;
