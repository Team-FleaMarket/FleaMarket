                                ...
                                <div class="">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 status-single">
                                            <c:if test="${status == 0}"><h4>待审核: ${goodsList.size()}
                                                件商品</h4></c:if>
                                            <c:if test="${status == 1}"><h4>待出售: ${goodsList.size()}
                                                件商品</h4></c:if>
                                            <c:if test="${status == 2}"><h4>已出售: ${goodsList.size()}
                                                件商品</h4></c:if>
                                            <c:if test="${status == 3}"><h4>我的购买: ${goodsList.size()}
                                                件商品</h4></c:if>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="search-container">
                                                <input type="text" id="searchInput" placeholder="搜索商品">
                                                <button class="search-button rounded-5" onclick="search()">Search
                                                </button>
                                            </div>
                                        </div>
                                    </div>
